...
HI_S32 SAMPLE_COMM_VPSS_Start(HI_S32 s32GrpCnt, SIZE_S *pstSize,
	...
	HI_S32 s32Ret;
	HI_S32 i, j;
	VPSS_CROP_INFO_S stClipInfo;
	VPSS_PRESCALE_INFO_S stScaleInfo;
	...
	for (i = 0; i < s32GrpCnt; i++) {
		...
		//zly crop 2014-03-25
		/*** set vpss param ***/
//		s32Ret = HI_MPI_VPSS_GetPreScale (VpssGrp,&stScaleInfo);
//		if (s32Ret != HI_SUCCESS) {
//					SAMPLE_PRT("failed with %#x!\n", s32Ret);
//					return HI_FAILURE;
//		}
//		stScaleInfo.bPreScale=HI_TRUE;
//		stScaleInfo.enCapSel=VPSS_CAPSEL_BUTT;
//		stScaleInfo.stDestSize.u32Width=752;
//		stScaleInfo.stDestSize.u32Height=576;
//		s32Ret=HI_MPI_VPSS_SetPreScale(VpssGrp,&stScaleInfo);
//		if (s32Ret != HI_SUCCESS) {
//					SAMPLE_PRT("failed with %#x!\n", s32Ret);
//					return HI_FAILURE;
//		}
//
//		s32Ret = HI_MPI_VPSS_GetCropCfg(VpssGrp, &stClipInfo);
//		if (s32Ret != HI_SUCCESS) {
//			return s32Ret;
//		}
//		stClipInfo.bEnable = HI_TRUE;
//		stClipInfo.enCropCoordinate = VPSS_CROP_ABS_COOR;
//		stClipInfo.stCropRect.s32X = 16;
//		stClipInfo.stCropRect.s32Y = 0;
//		stClipInfo.stCropRect.u32Width = 720;
//		stClipInfo.stCropRect.u32Height = 576;
//		s32Ret = HI_MPI_VPSS_SetCropCfg(VpssGrp, &stClipInfo);
//		if (s32Ret != HI_SUCCESS) {
//			SAMPLE_PRT("failed with %#x!\n", s32Ret);
//			return HI_FAILURE;
//		}
		...
		for (j = 0; j < s32ChnCnt; j++) {
			...
			//zly balck
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_LEFT] = 0x0000;
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_RIGHT] = 0x0000;
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_BOTTOM] = 0x0000;
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_TOP] = 0x0000;
			//zly

			//zly blue
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_LEFT] = 0x00FF;
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_RIGHT] = 0x00FF;
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_BOTTOM] = 0x00FF;
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_TOP] = 0x00FF;
			//zly red
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_LEFT] = 0xff0000;
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_RIGHT] = 0xff0000;
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_BOTTOM] = 0xff0000;
			stChnAttr.stFrame.u32Color[VPSS_FRAME_WORK_TOP] = 0xff0000;
