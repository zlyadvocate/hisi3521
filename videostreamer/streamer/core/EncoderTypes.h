...
#define AV_AUDIO_CODEC_G711A 3
#define AV_AUDIO_CODEC_G711U 4

#define AV_AUDIO_SAMPLERATE_UNKNOWN 0
#define AV_AUDIO_SAMPLERATE_11025 11025
#define AV_AUDIO_SAMPLERATE_16000 16000
#define AV_AUDIO_SAMPLERATE_22050 22050
#define AV_AUDIO_SAMPLERATE_32000 32000
...
//  bool isMulti();                                           /* check wether this is a multi packet (meaning that AVPacket::data contains pixels for multiple video streams and the strides/offsets are used to point to the correct planes */
  ...
  void allocate(size_t nbytes);  /* make sure that the data member can hold `nbytes` of data */
                  ...
                  /* either AV_TYPE_VIDEO or AV_TYPE_AUDIO */
