...
#define VIDEO_ENCODER_MEASURE_BITRATE 0  /* when set to 1 we will measure how many kbps the x264 encoder procuces per second. the calculated value is an avarage */
